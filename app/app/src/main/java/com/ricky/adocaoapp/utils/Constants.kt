...
object Constants {
    ...
    const val BASE_URL_WEBSOCKET: String = "ws://192.168.0.14:8080/ws"
    ...
    const val USER_CHATS_ENPOINT: String = "/usuario/get-users-by-sender-id"
    const val USER_DELETE_ACCOUNT: String = "/usuario/delete-user"
